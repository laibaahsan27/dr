    ...
    <div className="service2CON">
      ...
      <div className="servicepage2section2">
        ...
        <div className="service2sec2right">
          ...
          <div className="service2secrighttxt">
            Laser hair reduction employs concentrated beams of light that target
            the hair follicles, effectively inhibiting hair growth. The laser's
            energy is absorbed by the pigment (melanin) in the hair follicles,
            damaging them and preventing further hair growth. Our skilled
            practitioners{" "}
      ...
      <div className="serviceCover">
        <div className="service2Section1">
          ...
          <div><Image className="service2belowImage"src={THREE} alt="" /></div>
          
          <ServiceText list2={list3}/>
          <div><Image className="service2belowImage"src={FOUR} alt="" /></div>
          
          <ServiceText list2={list4}/>
          <div><Image className="service2belowImage"src={FIVE} alt="" /></div>
